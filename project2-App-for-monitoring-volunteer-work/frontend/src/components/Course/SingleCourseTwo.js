...
const SingleCourseTwo = (props) => {
    const { itemClass, courseID, courseImg, courseName, courseTitle, courseAuthor, courseAuthorImg, courseLesson, courseEnrolled, coursePrice, courseReview } = props;
	return(
        <div className={itemClass ? itemClass : 'single-studies col-lg-6 grid-item'}>
            <div className="inner-course">
                <div className="case-img">
                    ...
                    <img src={courseImg ? require(`../../assets/images//course/${courseImg}`) : require(`../../assets/images/course/${courseImg1}`)} alt="Course Image" />
                </div>
                <div className="case-content">
                    ...
                    <h4 className="case-title"> <Link to={`/course/${courseID}`}>{courseTitle}</Link></h4>
